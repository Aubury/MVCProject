...
class ModelProjectPage
{
    ...
    public function addProject($arr)
    {
       ...
       if(count($project)< 0){
           ...
           $sqlStr = $this->db->con->prepare("INSERT INTO `projects`(`name`, `budget`, `raiser_money`, `published`, `photo_1`, `photo_2`, `photo_3`, `photo_4`, `photo_5`, `video_1`, `video_2`, `text_1`, `text_2`) 
